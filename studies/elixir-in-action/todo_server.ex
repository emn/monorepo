...
defmodule TodoServer do
  ...
  def add_entry(e) do
    GenServer.cast(__MODULE__, {:add_entry, e})
  end
  ...
  def update_entry(i, e) do
    GenServer.cast(__MODULE__, {:update_entry, i, e})
  end

  def delete_entry(i) do
    GenServer.cast(__MODULE__, {:delete_entry, i})
  end

  @impl GenServer
  def handle_cast({:add_entry, e}, t) do
    {:noreply, TodoList.add_entry(t, e)}
  end

  @impl GenServer
  def handle_cast({:update_entry, i, e}, t) do
    {:noreply, TodoList.update_entry(t, i, e)}
  end

  @impl GenServer
  def handle_cast({:delete_entry, i}, t) do
    {:noreply, TodoList.delete_entry(t, i)}
  end

  @impl GenServer
  def handle_call({:entries, d}, _caller, t) do
    {:reply, {:todo_entries, TodoList.entries(t, d)}, t}
  end
end
